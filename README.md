...
你可以直接git clone https://github.com/shika-tina/email_collector_for_docker 並在樹莓派上實做(如果你有的話)，當然如果你是windows那麼就更簡單了，完全不用用這麼亂七八糟的東西，你只要直接使用laragon就好，它同樣也是一個網頁伺服器開發工具，不過那會比用docker簡單操作100萬倍